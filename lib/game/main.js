...
.defines(function(){
	...
	buildSPGame: function(){
	    ...
	    ig.game.spawnEntity( TopWall, 0, 8 );
	    ig.game.spawnEntity( TopWall, 0, ig.system.height - 8 );
	    ig.game.spawnEntity( LeftWall, 0, 8 );
	    ig.game.spawnEntity( LeftWall, ig.system.width - 8 , 8 );
    ...
    ig.main( '#canvas', PiSpace, 60, 480, 272, 1, ig.ImpactSplashLoader );
