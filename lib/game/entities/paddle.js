...
.defines(function(){
	...
	color: 'red',
		...
		[0, 0],
		[this.size.x/2, 0],
		[this.size.x, this.size.y/3],
		[this.size.x, 2 * this.size.y/3],
		[this.size.x/2, this.size.y],
		[0, this.size.y]
	    ];
	    //this.verts = this.emeraldVerts;
	    //this.verts = this.rectVerts;
	    //this.verts = this.ltDiaVerts;
	    //this.verts = this.rtTriVerts;
	    //this.verts = this.ltPhaseVerts;
	    this.setVerts( this.emeraldVerts );
